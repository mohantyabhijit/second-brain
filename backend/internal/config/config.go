...
type Config struct {
	...
	LangfusePromptManagementEnabled bool
	LangfusePromptLabel             string
	LangfuseDigestPromptName        string
...
func Load() Config {
	return Config{
		...
		LangfusePromptManagementEnabled: value("LANGFUSE_PROMPT_MANAGEMENT_ENABLED", "true") == "true",
		LangfusePromptLabel:             value("LANGFUSE_PROMPT_LABEL", "production"),
		LangfuseDigestPromptName:        value("LANGFUSE_DIGEST_PROMPT_NAME", "second-brain/digest-newsletter"),
